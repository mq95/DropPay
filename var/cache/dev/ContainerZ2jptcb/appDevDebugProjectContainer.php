...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HdtRv2xcbE', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nL-cKHmOd1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1q4JLisVbI', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QoKF8EHdVJ', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'images_directory': $value = ($this->targetDirs[3].'/web/assets/uploads/images'); break;
            case 'documents_directory': $value = ($this->targetDirs[3].'/web/assets/uploads/documents'); break;
            case 'vich_uploader.mappings': $value = array(
                'product_image' => array(
                    'uri_prefix' => '/assets/uploads/images',
                    'upload_destination' => ($this->targetDirs[3].'/web/assets/uploads/images'),
                ...
                'product_documents' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/uploads/documents'),
                    'inject_on_load' => false,
                    'delete_on_update' => true,
                    'delete_on_remove' => true,
                    'namer' => array(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 5432,
            'database_name' => 'bpmn_droppay',
            'database_user' => 'postgres',
            'database_password' => 'postgres',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'malak95q@gmail.com',
            'mailer_password' => 'malak1995',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'malak95q@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'malak1995',
